...
function maFonction() {
    ...
    // Pour connaitre la longueur de la chaine
    var str = "  bon jour  ";
    console.log(str.length); // Affiche 12
    ...
    var str2 = "Bonjour";
    // Extrait une sous-chaîne à partir de l'indice 3 (Rappel : on commence à partir de l'indice 0)
    ...
    //substring() => prend comme parametre de debut l'indice de fin (non inclus)
    console.log(str2.substring(1, 3)); // Affiche on 
    // Determine l'indice dfe la sous-chaine "jour" dans "bonjour"
    console.log(str2.indexOf("jour")); // Affiche 3
    console.log(str2.indexOf("soir")); // Affiche -1
    ...
    // console.log(dateDuJour.toString());
    ...
    if(x > 0) {
        console.log(x + "est strictement positif");
        // Utilisez esle if pour specifier une nouvelle condition, si la premiere condition est fausse
    }
    else if(x < 0 ) {
        console.log(x + "est strictement négatif");
    // specifier un bloc de code à executer si la meme condition est fausse
    }
    else {
    ...
    */ 
    ...
    // Boucle while à chaque itération, on teste si la condition est vraie 
    // avant d'acceder aux traitements 
    var i = 0;
    while (i <5){
        console.log(i);
    ...
    // Boucle do ... while : execute le bloc au moins une fois ensuite elle vérifie la condition
    do{
        console.log(i);
        i++;
    } while(i <5)
